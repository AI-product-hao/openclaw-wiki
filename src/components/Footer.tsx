...
const footerLinks = {
  tutorials: [
    ...
    { href: '/tutorials/beginner', label: 'Beginner' },
    { href: '/tutorials/advanced', label: 'Advanced' },
  ],
  resources: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400">
              The ultimate resource for OpenClaw AI agents, tutorials, and automation guides.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-zinc-200 dark:border-zinc-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-zinc-500 dark:text-zinc-500">
            © {new Date().getFullYear()} OpenClaw Wiki. All rights reserved.
          </p>
